...
#ns="1000 1500 2000 2500 3000 3500 4000 5000 6000 7000 8000 10000 11000 12000 13000 15000 17000 20000 21000 22000"
  ...
  then
	...
	echo $dOut
        ...
        then
          ...
          data_file="test_series_d_in_const_DInOut${dIn}_${dOut}_${map}.data"
